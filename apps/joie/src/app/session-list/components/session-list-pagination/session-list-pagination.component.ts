...
@Component({
  selector: 'app-session-list-pagination',
  templateUrl: './session-list-pagination.component.html',
  styleUrls: ['./session-list-pagination.component.scss']
})
export class SessionListPaginationComponent implements OnInit {
  ...
  getItems() {
    this.sessionsService.getSessionsData('sessions', this.pageCount, this.queryFn).subscribe((response: any) => {
      ...
      console.log('paginationClickedCount = ', this.paginationClickedCount);
      this.prevStrtAt = [];
      this.disableNext = false;
      this.disablePrev = true;
  ...
  prevPage() {
    ...
    this.sessionsService.getSessionsPrev('sessions', this.pageCount, this.get_prev_startAt(), this.firstInResponse, this.queryFn).subscribe((response: any) => {
      ...
      this.paginationClickedCount--;      console.log('paginationClickedCount = ', this.paginationClickedCount);
