export const list = [
  {
    ...
    name: 'Free to Join',
    description:
      `Joie is free to join. We believe in true partnership with our teachers-when they succeed we do too.
  ...
  },
  {
    ...
    description:
      `Joie eliminates the headache of managing a business. With an easy to use platform, we reduce the time spent on paperwork and logistics.
  ...
  },
  {
    ...
    name: 'Expanded Reach',
    description:
      `With Joie, the world is your classroom. You can reach new markets and connect with students around the globe from your camera or desk.
  ...
  },
  {
    ...
    description:
      `Joie offers many contribution channels for you, our teachers, to share your knowledge and philosophy with our worldwide community. We invite you to share articles, videos, interviews and participate in professional panels to promote your philosophy and sessions.`,
  },
  {
    icon: 'parallelogram',
    name: 'Scale-Up Your Business',
    description:
      `Joie offers scalability and efficiency for your business. Turn your service to a product and earn more from every hour you teach. Diversify your curriculums by using different session formats, to sell more effectively and generate more revenue.`,
  },
  {
    icon: 'income',
    name: 'Residual Income',
    description:
      `Joie can accelerate your income goals and help you spend more time on the things you love.
  ...
  },
  {
    ...
    description:
      `Joie wants every instructor to succeed. Consider us your virtual partner in creating a thriving practice.
  ...
  },
  {
    ...
    description:
      `We’ll handle the tech; you handle the classes. With video, messaging, and a comprehensive suite of marketing and data tools,
