...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["account-account-module"], {
  ...
  function srcAppAccountAccountRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _containers_account_dashboard_account_dashboard_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./containers/account-dashboard/account-dashboard.component */
    "./src/app/account/containers/account-dashboard/account-dashboard.component.ts");

    var routes = [{
      path: '',
      component: _containers_account_dashboard_account_dashboard_component__WEBPACK_IMPORTED_MODULE_2__["AccountDashboardComponent"]
    }];
  ...
  function srcAppAccountAccountModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _containers_account_dashboard_account_dashboard_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./containers/account-dashboard/account-dashboard.component */
    "./src/app/account/containers/account-dashboard/account-dashboard.component.ts");
  ...
  /***/
  function srcAppAccountContainersAccountDashboardAccountDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_auth_state_state_auth_facades_auth_facade__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/app/auth-state/+state/auth/facades/auth.facade */
    "./src/app/auth-state/+state/auth/facades/auth.facade.ts");
    /* harmony import */


    var _shared_components_payment_source_payment_source_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../../shared/components/payment-source/payment-source.component */
    ...
    var AccountDashboardComponent = function AccountDashboardComponent(authFacade) {
    ...
    AccountDashboardComponent.ɵfac = function AccountDashboardComponent_Factory(t) {
      return new (t || AccountDashboardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_auth_state_state_auth_facades_auth_facade__WEBPACK_IMPORTED_MODULE_1__["AuthFacade"]));
    };

    AccountDashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_shared_components_payment_source_payment_source_component__WEBPACK_IMPORTED_MODULE_2__["PaymentSourceComponent"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AccountDashboardComponent, [{
        ...
        return [{
          type: src_app_auth_state_state_auth_facades_auth_facade__WEBPACK_IMPORTED_MODULE_1__["AuthFacade"]
        }];
      }, null);
    })();
    /***/
